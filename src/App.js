...
export default function App() {
  ...
  useEffect(() => {
    ...
    scriptTag.setAttribute('data-ad-client', 'ca-pub-9002113341910262');
    scriptTag.src =
          ...
          <Row justify='start' style={{ padding: '20px' }}>
            ...
            <Col>
              ...
              <Typography.Paragraph>
                ...
                lowercase as well as converting i’s into I’s. Every letter after
                a full stop will get converted into an upper case letter.
              </Typography.Paragraph>
              <Typography.Paragraph>
            ...
            <Col>
              ...
              <Typography.Paragraph>
                ...
                converter will allow you to do - it transforms all the letters
                in your text into lowercase letters. Simply copy the text that
                you need generating into lower case and paste the text into the
                box above and select the ‘lower case’ button.
              </Typography.Paragraph>
              <Typography.Paragraph code>
            ...
            <Col>
              ...
              <Typography.Paragraph>
                ...
                as keep upper case letters as upper case letters).
              </Typography.Paragraph>
              <Typography.Paragraph>
            ...
            <Col>
              ...
              <Typography.Paragraph>
                Transformer will take any text that you have and will generate
                the first letter into upper case, the upper case first will do
                this for you.
              </Typography.Paragraph>
              <Typography.Paragraph>
                To do this, you simply have to select the text that you need
            ...
            <Col>
              ...
              <Typography.Paragraph>
                The lower case first transformer will take any text that you
                have and will generate the first letter into lower case.
              </Typography.Paragraph>
              <Typography.Paragraph>
            ...
            <Col>
              ...
              <Typography.Paragraph>
                The constant case transformer will take any text that you have
                and will generate in the format constant case.
              </Typography.Paragraph>
              <Typography.Paragraph code>
            ...
            <Col>
              ...
              <Typography.Paragraph>
                The no case transformer will take any text that you have and
                will generate with no case.
              </Typography.Paragraph>
              <Typography.Paragraph code>
            ...
            <Col>
              ...
              <Typography.Paragraph>
                The dot case transformer will take any text that you have and
                will generate in the format dot case.
              </Typography.Paragraph>
              <Typography.Paragraph code>
            ...
            <Col>
              ...
              <Typography.Paragraph>
                The capital case converter will automatically convert the
              ...
              <Typography.Paragraph>
                ...
                format, then paste into the box form above and select the
                Capital Case button.
              </Typography.Paragraph>
              <Typography.Paragraph code>
            ...
            <Col>
              ...
              <Typography.Paragraph>
                The swap case converter will allow you to transform your text
                (no matter the current format) into text that alternates between
                lower case and upper case. It will generate a capital letter and
                then a lower case letter within the same word.
              </Typography.Paragraph>
              <Typography.Paragraph code>
