      ...
      <Layout style={{ minHeight: '100vh' }}>
        <Header style={{ height: '50px' }}>
          <Row slign='middle' justify='center'>
            <Title level={2} style={{ color: '#1890ff', marginTop: '5px' }}>
              T
            </Title>
      ...
      <Row justify='start' style={{ padding: '20px' }}>
        ...
        <Col>
          ...
          <Typography.Paragraph>
            The sentence case converter allow you to paste any text you’d like,
            and it will automatically transform it to a fully formed structured
            sentence.
          </Typography.Paragraph>
          <Typography.Paragraph>
            It works by capitalizing the very first letter in each sentence, and
            will then go on to transform the rest of the text into lowercase as
            well as converting i’s into I’s. Every letter after a full stop will
            get converted into an upper case letter.
          </Typography.Paragraph>
          <Typography.Paragraph>
            Note: it won’t, however, capitalize names or places.
          </Typography.Paragraph>
          <Typography.Paragraph>
            This is an example of sentence case. Note the upper letter "N" after
            the dot.
          </Typography.Paragraph>
        </Col>
        ...
        <Col>
          ...
          <Typography.Paragraph>
            ...
            into the box above and select the ‘lower case’ button.
          </Typography.Paragraph>
          <Typography.Paragraph>
        ...
        <Col>
          ...
          <Typography.Paragraph>
            ...
            case letters as upper case letters).
          </Typography.Paragraph>
          <Typography.Paragraph>
        ...
        <Col>
          ...
          <Typography.Paragraph>
            The upper case first transformer will take any text that you have
            and will generate the first letter into upper case.
          </Typography.Paragraph>
          <Typography.Paragraph>
            To do this, you simply have to select the text that you need
            changing and pasting into the box above and then select the Upper
        ...
        <Col>
          ...
          <Typography.Paragraph>
            To do this, you simply have to select the text that you need
            changing and pasting into the box above and then select the lower
            case first button.
          </Typography.Paragraph>
          <Typography.Paragraph>
        ...
        <Col>
          ...
          <Typography.Paragraph>
            ...
            correct letters are capitalized within the context of a title. Words
            such as “an” will be left all in lower case and words that are
            important will be converted such as “Title”.
          </Typography.Paragraph>
          <Typography.Paragraph>
